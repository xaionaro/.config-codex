...
Launch a dedicated code-reviewer subagent with `spawn_agent`; include the filled `requesting-code-review/code-reviewer.md` prompt in the subagent prompt body.
...
[Launch dedicated code-reviewer subagent with `spawn_agent`]
