...
>
> Before the one provisional action, waive normal ECI Step 1/2, coding-style admission, TDD, tests, E2E, and critic review. Route one implementer to make only the smallest repair. Report it exactly as **“provisional Emergency Unblock — unchecked”**; never call it fixed, accepted, complete, reviewed, proven, or ready to commit.
>
