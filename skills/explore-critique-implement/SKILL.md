...
Multiple E2E-ready tasks may share one batched E2E run when scarce resources would contend and batching meaningfully cuts wall time; report separate verdicts per task.
