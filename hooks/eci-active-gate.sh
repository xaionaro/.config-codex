...
reason="ECI is active for this ${tool_name} edit. Delegate repository edits to the assigned implementer; direct main-thread edits are prohibited. This denial governs edit routing only. Marker: $marker_text"
