...
assert_allowed 'git checkout --inter-hunk-context=3 --unified=-1 -- hooks/validate-bash.sh'
assert_allowed 'git checkout --unified=-1 --inter-hunk-context=3 -- hooks/validate-bash.sh'
